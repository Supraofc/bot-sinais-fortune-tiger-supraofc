# SupraOfc - Bot de Sinais para Telegram

## Como Usar:

1. **Clone o Repositório:**
   ```bash
   git clone https://github.com/SupraOfc/telegram-bot.git
...
Criador:
Este bot foi desenvolvido por SupraOfc. Siga-o no GitHub para mais projetos interessantes.